...
class PolymarketHybridPredictor:
    ...
    def predict(
        ...
        X_scaled = self.scaler.transform(market_features[self.feature_names])
    ...
    def _triple_combine(
        ...
        return {
            ...
            "expected_resolution_path": claude_result.get(
...
# Backwards-compat alias for code that imports the twitch class name.
TwitchHybridPredictor = PolymarketHybridPredictor


_ = config

__all__ = ["PolymarketHybridPredictor", "TwitchHybridPredictor"]
