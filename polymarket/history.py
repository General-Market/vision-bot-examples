...
per request, time-bounded. A polymarket batch typically holds a few
hundred markets and fits in a handful of chunked requests; the same
client scales to thousands when the batch grows.
"""
