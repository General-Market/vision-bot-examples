"""Live trading loop for the Polymarket batch on Vision testnet.

Each iteration:
  1. Discover the current polymarket batch and its config hash.
...
def main():
    ...
    p.add_argument("--source", default="polymarket")
