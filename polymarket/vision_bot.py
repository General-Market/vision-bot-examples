...
class VisionBot:
    ...
    def discover_source(self, source_id: str = "polymarket") -> dict:
    ...
    def fetch_snapshot(self, source_id: str = "polymarket") -> dict[str, dict]:
        ...
        returns a mixed-source sample of 10k rows and any single source is
        capped at ~500 (the default per-source sample ceiling).
        """
        r = _retry_get(
